...
//	 		if ( SCRIPT_DEBUG == true ) {
	 			...
	 			$hooks_script_url = $this->get_plugin_url( '/js/sce-event-manager.js' );
//	 		}
//	 	}
	 	require_once( 'class-sce-timer.php' );
	 	$timer_internationalized = new SCE_Timer();
	 	wp_enqueue_script( 'wp-hooks-sce', $hooks_script_url, array(), '20171110', true ); //https://core.trac.wordpress.org/attachment/ticket/21170/21170-2.patch
	 	wp_enqueue_script( 'simple-comment-editing', $main_script_uri, array( 'jquery', 'wp-ajax-response' ), '20171110', true );
